module.exports = [
"[project]/.next-internal/server/app/api/admin/convocatorias/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/admin/convocatorias/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!partidoId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Missing partido_id"
            }, {
                status: 400
            });
        }
        const { data: convocatorias, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("convocatorias").select(`
        id,
        asiste,
        comentario,
        jugador_id,
      ...
      `).eq("partido_id", partidoId);
        ...
        // Flatten logic
        const results = (convocatorias ?? []).map((c)=>({
                id: c.id,
                asiste: c.asiste,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__71d14076._.js.map