module.exports = [
"[project]/.next-internal/server/app/api/players/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
    ...
    try {
        ...
        if (!equipoId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Falta el parámetro equipo_id"
            }, {
                status: 400
            });
        }
        // 1. Consulta: Traemos a los jugadores (ya contienen sus 'goles')
        const { data: jugadores, error: jugadoresError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("jugadores").select("*").eq("equipo_id", equipoId).order("dorsal", {
            ascending: true
        });
        if (jugadoresError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: jugadoresError.message
            }, {
                status: 500
            });
        }
        ...
        const jugadoresConGoles = jugadores?.map((jugador)=>{
            return {
                ...jugador,
                goles_totales: jugador.goles || 0
            };
        }) || [];
        // 3. Extra (Consideración oportuna): Creamos un ranking de los máximos goleadores
        const topGoleadores = [
            ...jugadoresConGoles
        ].sort((a, b)=>b.goles_totales - a.goles_totales).slice(0, 15);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            jugadores: jugadoresConGoles,
            total_jugadores: jugadoresConGoles.length,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__412e9bf9._.js.map