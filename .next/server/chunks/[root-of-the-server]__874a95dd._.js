    ...
    try {
        ...
        if (!equipoId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Missing equipo_id"
            }, {
                status: 400
            });
        }
        // Partidos de ese equipo (todos los formatos)
        const { data: partidos, error: partidosError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("partidos").select("*").eq("equipo_id", equipoId).order("fecha", {
            ascending: true
        });
        if (partidosError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (partidoIds.length > 0) {
            const { data: goleadores, error: goleadoresError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("goleadores_partido").select("id, partido_id, jugador_id, goles, jugadores(nombre)").in("partido_id", partidoIds);
            if (goleadoresError) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: goleadoresError.message
                }, {
                    status: 500
                });
            }
            goleadoresFlat = (goleadores ?? []).map((g)=>({
                    id: g.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__874a95dd._.js.map