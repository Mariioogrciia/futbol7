...
"[project]/components/editable-avatar.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function EditableAvatar({ jugadorId, currentFotoUrl, jugadorNombre }) {
    const defaultAvatar = `https://ui-avatars.com/api/?name=${encodeURIComponent(jugadorNombre)}&background=0D8ABC&color=fff&size=200`;
    const [avatarUrl, setAvatarUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(currentFotoUrl || defaultAvatar);
    ...
    const [canEdit, setCanEdit] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const uploadAvatar = async (event)=>{
        try {
            ...
            const { error: uploadError, data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('galeria').upload(filePath, file, {
                upsert: true
            });
            if (uploadError) {
                throw uploadError;
            ...
            // 2. Get public URL
            const { data: publicUrlData } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('galeria').getPublicUrl(filePath);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Foto de perfil actualizada correctamente");
            router.refresh(); // Tells Next.js to re-fetch Server Components
        } catch (error) {
            console.error("Error uploading avatar:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.message || "No se pudo subir la foto de perfil.");
        } finally{
...
//# sourceMappingURL=_e650ee5c._.js.map