module.exports = [
"[project]/.next-internal/server/app/api/players/avatar/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/players/avatar/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("jugadores").update({
            foto_url: foto_url
        }).eq("id", jugador_id).select();
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__de00e52d._.js.map