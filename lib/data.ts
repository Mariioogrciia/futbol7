...
export const players: Player[] = [
  ...
  { id: 13, name: "Mario García", position: "Delantero", number: 21, description: "Claro ejemplo de que no hay que jugar en el futbol 7 (lesión en 2 partidos).", avatar: "/images/lesion.jpg" },
